...
class _MyAppState extends State<MyApp> {
  ...
  Future getWeather() async {
    ...
    http.Response response = await http.get(
        "http://api.openweathermap.org/data/2.5/weather?q=$localidade&Brazil&appid=e8962427977895dc7b82576019a60ef1");
    ...
    return new Column(
      children: <Widget>[
        ...
        Container(
          ...
          child: Text('Logradouro: ' + logradouro.toString(),
              style: TextStyle(
                fontSize: 30,
              )),
        ),
        Container(
          ...
          child: Text('Bairro: ' + bairro.toString(),
              style: TextStyle(
                fontSize: 30,
              )),
        ),
        Container(
          ...
          child: Text('Localidade: ' + localidade.toString(),
              style: TextStyle(
                fontSize: 30,
              )),
        ),
        Container(
          ...
          margin: const EdgeInsets.only(bottom: 10.0),
          color: Colors.cyan[300],
          child: Text('Clima: ' + tempoDescricao.toString(),
              style: TextStyle(
                fontSize: 30,
              )),
        ),
        ...
        Container(
          ...
          margin: const EdgeInsets.only(bottom: 10.0),
          color: Colors.red[300],
          child: Text('Umidade do Ar: ' + umidadeAr.toString(),
              style: TextStyle(
                fontSize: 30,
              )),
        ),
